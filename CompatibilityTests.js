...
(function (document) {
    ...
    QUnit.module("Compatibility Tests");
    ...
    function expectValid(name, scenario) {
        QUnit.test(name, function (assert) {
            var isCompatible = AgentCompatible.UserAgentStringIsCompatible(scenario.UserAgentString);
    ...
    for (var i = 0; i < validTests.length; i++) {
        var name = validTests[i].Name + " v" + validTests[i].Version + " is compatible.";
     ...
     * UserAgentString is not compatible.
     */
